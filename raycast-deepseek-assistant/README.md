...
Raycast extension for calling the DeepSeek Chat Completions API directly from a command.
...
The extension calls DeepSeek directly and shows the response below the input line. Use the actions to copy the answer or the full result.
